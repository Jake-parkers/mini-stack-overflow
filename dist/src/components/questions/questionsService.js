...
const questionsDAL_1 = __importDefault(require("./questionsDAL"));
...
class QuestionsService {
    saveQuestion(question) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield questionsDAL_1.default.save(question);
            }
            catch (error) {
    ...
    viewQuestions(page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const questions = yield questionsDAL_1.default.getQuestions(page, limit);
                const totalQuestions = yield questionsDAL_1.default.totalQuestions();
    ...
    createSubscription(userId, questionId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield questionsDAL_1.default.saveSubscription(userId, questionId);
            }
            catch (error) {
                error_1.handler.handleError(error);
                return new error_1.default("", httpStatusCodes_1.HttpStatusCode.INTERNAL_SERVER_ERROR, commonErrors_1.CommonErrors.DATABASE_ERROR, false);
